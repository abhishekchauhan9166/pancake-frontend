...
import { Flex, Text, useMatchBreakpoints, useModal } from '@pancakeswap/uikit'
...
export const Wrapper = styled.div`
  border-radius: 24px;
  background: ${({ theme }) => (theme.isDark ? theme.colors.lightBlue : '#496AF1')};
  width: 100%;
  box-sizing: border-box;
  padding: 48px 24px 24px 24px;
  min-height: 360px;
    ...
    return [
      {
        ...
        image: `/images/mercadex/Trade/Swap.png`,
      ...
      },
      {
        ...
        ctaTitle: t('Add Now'),
        image: `/images/mercadex/Trade/Liquidity.png`,
      ...
      },
      {
        ...
        image: `/images/mercadex/Trade/Bridge.png`,
      ...
      },
      {
        ...
        ctaTitle: t('Trade Now'),
        image: `/images/mercadex/Trade/Perpetual.png`,
      ...
      },
      {
        ...
        ctaTitle: t('Buy Now'),
        image: `/images/mercadex/Trade/Crypto.png`,
...
//         description: t('Automate your Merca Dex v3 liquidity'),
//         ctaTitle: t('Stake Now'),
...
//         description: t('Play, Build and Connect on Merca Dex'),
//         ctaTitle: t('Play Now'),
...
const EcoSystemSection: React.FC = () => {
  ...
  return (
    <>
      <StyledFlex justifyContent="center" alignItems="center" flexDirection="column" pt={isMobile ? '24px' : '60px'}>
        <Text
        ...
        <Wrapper>
          ...
          >
            <Image
              style={{ marginLeft: isMobile ? 0 : -144 }}
              src="/images/mercadex/trade.png"
              alt="trade-bunny"
              width={340}
              height={340}
              unoptimized
            ...
            <Flex flexDirection="column">
              <Title style={{ color: '#fff' }}>{t('Trade')}</Title>
              <FeatureBoxesWrapper style={{ padding: '0px 20px 30px' }}>
